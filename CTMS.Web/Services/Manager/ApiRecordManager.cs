...
namespace CTMS.Web.Services
{
    ...
    public class ApiRecordManager: IApiRecordManager
    {
        ...
        private Sys_InterfaceAccount GetSysInterfaceAccount(int systemId, string appId)
        {
            try
            {
        ...
        private Sys_InterfaceAccount GetSysInterfaceAccountByUuID(int systemId, string uuid)
        {
            try
            {
        ...
        private Sys_InterfaceAccessToken GetSysInterfaceAccessToken(string token)
        {
            try
            {
                ...
                if (entity == null)
                    return null;
                return entity.ToObject<Sys_InterfaceAccessToken>();
            }
            catch (Exception ex)
            {
                throw new Exception(ex.Message);
        ...
        private Member_AccessToken GetMemberAccessToken(string token)
        {
            try
            {
                ...
                if (entity == null)
                    return null;
                return entity.ToObject<Member_AccessToken>();
            }
            catch (Exception ex)
            {
                throw new Exception(ex.Message);
        ...
        private long SaveWebApiAccessRecord(string appId, string parameter, RecordType recordType)
        {
            try
            {
                ...
                var entity = new Log_WebApiAccessRecord()
                {
                    SystemID = SystemID,
                    CompanyID = companyId,
                    AppID = appId,
