...
namespace CTMS.Web.Services
{
    ...
    public partial class BaseApiManager:IBaseApiManager
    {
        ...
        public Sys_InterfaceAccount GetInterfaceAccount(string companyId, string account)
        {
            try
            {
                var entity = InterfaceAccountService.GetInterfaceAccountPro(SystemID, companyId, account);
                return entity.ToObject<Sys_InterfaceAccount>();
            }
            catch (Exception ex)
            {
                throw new Exception(ex.Message);
        ...
        public Sys_InterfaceAccount GetInterfaceAccountByToken(string token)
        {
            try
            {
        ...
        public Sys_InterfaceAccount GetInterfaceAccountByUuid(string uuid)
        {
            try
            {
        ...
        public Sys_InterfaceAccount GetInterfaceAccountByAppID(string appid)
        {
            try
            {
        ...
        public Member_Account GetMemberAccount(string companyId,string memberId)
        {
            try
            {
        ...
        public Member_Account GetMemberAccountByAccessToken(string accessToken)
        {
            try
            {
        ...
        public Member_Account GetMemberAccountByRefreshToken(string refreshToken)
        {
            try
            {
