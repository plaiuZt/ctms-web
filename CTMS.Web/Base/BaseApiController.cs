...
namespace CTMS.Web
{
    ...
    public class BaseApiController : ControllerBase
    {
        ...
        protected virtual Sys_InterfaceAccount GetInterfaceAccountByToken(string token)
        {
            try
            {
        ...
        protected virtual Sys_InterfaceAccount GetInterfaceAccountByUuid(string uuid)
        {
            try
            {
