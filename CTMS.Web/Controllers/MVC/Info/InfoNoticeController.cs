    ...
    public class InfoNoticeController : BaseController
    {
        ...
        public IActionResult List()
        {
            try
            {
                ...
                int total = 100;
                List<Info_Notice> lists = new List<Info_Notice>();
                ...
                if (string.IsNullOrWhiteSpace(strKeyword))
                    ...
                    lists = NoticeService.SearchNotice(SystemID, CompanyID, startTime, endTime, classId, state, keyword, total);
        ...
        public JsonResult Save(string noticeId)
        {
            try
            {
                ...
                Info_Notice entity = new Info_Notice()
                {
                    SystemID = SystemID,
                    CompanyID = CompanyID,
                    NoticeID = noticeId,
