    ...
    public class InfoArticeController : BaseController
    {
        ...
        public IActionResult List()
        {
            try
            {
                ...
                bool delete = false;
                int total = 100;
                List<Info_Artice> lists = new List<Info_Artice>();
                ...
                if (string.IsNullOrWhiteSpace(strKeyword))
                    ...
                    lists = ArticeService.SearchArtice(SystemID, CompanyID, startTime, endTime, classId, state, keyword, delete, total);
        ...
        public IActionResult Add(string classId, string articeId)
        {
            try
            {
                ...
                if (string.IsNullOrWhiteSpace(articeId))
                    return View(new Info_Artice() { CreateDate = DateTime.Now });
        ...
        public JsonResult Save(string articeId)
        {
            try
            {
                ...
                Info_Artice entity = new Info_Artice()
                {
                    SystemID = SystemID,
                    CompanyID = CompanyID,
                    ArticeID = articeId,
