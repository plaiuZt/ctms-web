    ...
    public class InfoNoticeCategoryController : BaseController
    {
        ...
        public IActionResult List()
        {
            try
            {
                ...
                List<Info_NoticeCategory> lists = NoticeCategoryService.GetNoticeCategory(SystemID, CompanyID);
        ...
        public IActionResult Add(string categoryId = "")
        {
            try
            {
                ...
                if (string.IsNullOrWhiteSpace(categoryId))
                    return View(new Info_NoticeCategory());
        ...
        public JsonResult Save(string categoryId)
        {
            try
            {
                ...
                Info_NoticeCategory entity = new Info_NoticeCategory()
                {
                    SystemID = SystemID,
                    CompanyID = CompanyID,
