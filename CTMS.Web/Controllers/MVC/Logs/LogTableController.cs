...
namespace CTMS.Web.Controllers.MVC.Logs
{
    ...
    public class LogTableController : BaseController
    {
        ...
        public LogTableController(IBaseManager BaseManager, ITableService TableService, ITableDetailsService TableDetailsService, ITableOperationManager<Log_LoginRecord> TableOperationManager) : base(BaseManager)
        {
        ...
        public IActionResult List()
        {
            try
            {
                ...
                long totalNum = 0;
                List<Log_Table> lists = new List<Log_Table>();
