...
namespace CTMS.Service.Sys
{
    ...
    /// 系统接口帐号访问白名单业务逻辑服务类
    /// </summary>
    public partial class InterfaceAccessWhiteListService : BaseService<Sys_InterfaceAccessWhiteList>, IInterfaceAccessWhiteListService
    {
        private readonly IInterfaceAccessWhiteListDAL InterfaceAccessWhiteListDAL;
        private readonly CTMSContext CTMSContext;
        public InterfaceAccessWhiteListService(CTMSContext CTMSContext, IInterfaceAccessWhiteListDAL InterfaceAccessWhiteListDAL)
        {
        ...
        public bool SaveInterfaceAccessWhiteListPro(int systemId, string companyId, string account, string ipAddress, int classId, string className, string remark, bool state)
        {
            try
            {
                int errCode = -1;
                string errMsg = "fail";
                var result = CTMSContext.SP_Add_Sys_InterfaceAccessWhiteList(systemId, companyId, account, ipAddress, classId, className, remark, state, out errCode, out errMsg);
                if (errCode != 0)
        ...
        public bool DeleteInterfaceAccessWhiteListPro(int systemId, string companyId, string account, string ipAddress, int classId)
        {
            try
            {
                int errCode = -1;
                string errMsg = "fail";
                var result = CTMSContext.SP_Delete_Sys_InterfaceAccessWhiteList(systemId, companyId, account, ipAddress, classId, out errCode, out errMsg);
                if (errCode != 0)
                    throw new Exception(errMsg);
                return result > 0;
            }
        ...
        public bool UpdateInterfaceAccessWhiteListPro(int systemId, string companyId, string account, string ipAddress, int classId, string className, string remark, bool state)
        {
            try
            {
                int errCode = -1;
                string errMsg = "fail";
                var result = CTMSContext.SP_Update_Sys_InterfaceAccessWhiteList(systemId, companyId, account, ipAddress, classId, className, remark, state, out errCode, out errMsg);
                if (errCode != 0)
                    throw new Exception(errMsg);
                return result > 0;
            }
        ...
        public List<SP_Get_Sys_InterfaceAccessWhiteList> GetInterfaceAccessWhiteListPro(int systemId, string companyId, string account, string ipAddress)
        {
            try
            {
                int errCode = -1;
                string errMsg = "fail";
                var result = CTMSContext.SP_Get_Sys_InterfaceAccessWhiteList(systemId, companyId, account, ipAddress, out errCode, out errMsg);
                if (errCode != 0)
                    throw new Exception(errMsg);
                if (result == null)
                    return null;
        ...
        public List<SP_Get_Sys_InterfaceAccessWhiteListByAccount> GetInterfaceAccessWhiteListByAccountPro(int systemId, string companyId, string account)
        {
            try
            {
                int errCode = -1;
                string errMsg = "fail";
                var result = CTMSContext.SP_Get_Sys_InterfaceAccessWhiteListByAccount(systemId, companyId, account, out errCode, out errMsg);
                if (errCode != 0)
                    throw new Exception(errMsg);
                if (result == null)
                    return null;
        ...
        public bool VerifyInterfaceAccessWhiteListPro(int systemId, string companyId, string account, string ipAddress)
        {
            try
            {
                int errCode = -1;
                string errMsg = "fail";
                var result = CTMSContext.SP_Verify_Sys_InterfaceAccessWhiteList(systemId, companyId, account, ipAddress, out errCode, out errMsg);
                if (errCode != 0)
                    throw new Exception(errMsg);
        ...
        public bool VerifyInterfaceAccessWhiteListByAccessTokenPro(int systemId, string accessToken, string ipAddress)
        {
            try
            {
                int errCode = -1;
                string errMsg = "fail";
                var result = CTMSContext.SP_Verify_Sys_InterfaceAccessWhiteListByAccessToken(systemId, accessToken, ipAddress, out errCode, out errMsg);
                if (errCode != 0)
                    throw new Exception(errMsg);
                return errCode == 0 ? true : false;
            }
        ...
        public bool VerifyInterfaceAccessWhiteListByAppIdPro(int systemId, string appId, string ipAddress)
        {
            try
            {
                int errCode = -1;
                string errMsg = "fail";
                var result = CTMSContext.SP_Verify_Sys_InterfaceAccessWhiteListByAppId(systemId, appId, ipAddress, out errCode, out errMsg);
                if (errCode != 0)
                    throw new Exception(errMsg);
                return errCode == 0 ? true : false;
            }
