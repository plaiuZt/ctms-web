...
namespace CTMS.Service.Member
{
    ...
    /// 
    /// </summary>
    public partial class AccountService:BaseService<Member_Account>,IAccountService
    {
        ...
        public Member_Account GetAccount(int systemId, string companyId, string memberId)
        {
            try
            {
        ...
        public Member_Account GetAccountByUserName(int systemId, string companyId, string username)
        {
            try
            {
        ...
        public List<Member_Account> GetAccountPaging(int systemId, string companyId, int pageId, int pageSize)
        {
            try
            {
                var expression = ExtLinq.True<Member_Account>();
        ...
        public bool SaveAccount(Member_Account entity)
        {
            try
            {
        ...
        public bool UpdateAccount(Member_Account entity)
        {
            try
            {
                int systemId = entity.SystemID;
        ...
        public bool SaveAccountRegisterPro(int systemId, string companyId, string memberId, string password, string phone, string ipAddress)
        {
            try
            {
                int errCode = -1;
                string errMsg = "fail";
                var result = CTMSContext.SP_Add_Member_AccountRegister(systemId, companyId, memberId, password, phone, ipAddress, out errCode, out errMsg);
                if (errCode != 0)
        ...
        public bool UpdateAccountStatePro(int systemId, string companyId, string memberId, bool state)
        {
            try
            {
                int errCode = -1;
                string errMsg = "fail";
                var result = CTMSContext.SP_Update_Member_AccountState(systemId, companyId, memberId, state, out errCode, out errMsg);
                if (errCode != 0)
                    throw new Exception(errMsg);
                return errCode == 0 ? true : false;
            }
        ...
        public bool UpdateAccountDeletePro(int systemId, string companyId, string memberId, bool delete)
        {
            try
            {
                int errCode = -1;
                string errMsg = "fail";
                var result = CTMSContext.SP_Update_Member_AccountDelete(systemId, companyId, memberId, delete, out errCode, out errMsg);
                if (errCode != 0)
                    throw new Exception(errMsg);
                return errCode == 0 ? true : false;
            }
        ...
        public bool UpdateAccountPasswordPro(int systemId, string companyId, string memberId, string password)
        {
            try
            {
                int errCode = -1;
                string errMsg = "fail";
                var result = CTMSContext.SP_Update_Member_AccountPassword(systemId, companyId, memberId, password, out errCode, out errMsg);
                if (errCode != 0)
                    throw new Exception(errMsg);
                return errCode == 0 ? true : false;
            }
        ...
        public bool DeleteAccountPro(int systemId, string companyId, string memberId)
        {
            try
            {
                int errCode = -1;
                string errMsg = "fail";
                var result = CTMSContext.SP_Delete_Member_Account(systemId, companyId, memberId, out errCode, out errMsg);
                if (errCode != 0)
                    throw new Exception(errMsg);
                return errCode == 0 ? true : false;
            }
        ...
        public Member_Account GetAccountByAccessTokenPro(int systemId, string accessToken)
        {
            try
            {
                if (systemId == 0)
                ...
                int errCode = -1;
                string errMsg = "fail";
                var result = CTMSContext.SP_Get_Member_AccountByAccessToken(systemId, accessToken, out errCode, out errMsg);
                if (errCode != 0)
                    throw new Exception(errMsg);
                if (result == null)
                    return null;
                else
                    return result.ToObject<List<Member_Account>>().FirstOrDefault();
            }
            catch (Exception ex)
            {
                throw new Exception(ex.Message);
        ...
        public Member_Account GetAccountByRefreshTokenPro(int systemId, string refreshToken)
        {
            try
            {
                if (systemId == 0)
                ...
                int errCode = -1;
                string errMsg = "fail";
                var result = CTMSContext.SP_Get_Member_AccountByRefreshToken(systemId, refreshToken, out errCode, out errMsg);
                if (errCode != 0)
                    throw new Exception(errMsg);
                if (result == null)
                    return null;
        ...
        public Member_Account GetAccountPro(int systemId, string companyId, string memberId)
        {
            try
            {
                if (systemId == 0)
                ...
                int errCode = -1;
                string errMsg = "fail";
                var result = CTMSContext.SP_Get_Member_Account(systemId, companyId, memberId, out errCode, out errMsg);
                if (errCode != 0)
                    throw new Exception(errMsg);
                if (result == null)
                    return null;
        ...
        public List<Member_Account> GetAccountPagingPro(int systemId, string companyId, string delete, int pageId, int pageSize, out int rowCount)
        {
            try
            {
                int errCode = -1;
                string errMsg = "fail";
                var result = CTMSContext.SP_Get_Member_AccountPaging(systemId, companyId, delete, pageId, pageSize, out errCode, out errMsg, out rowCount);
                if (errCode != 0)
                    throw new Exception(errMsg);
                if (result == null)
                    return null;
                else
                    return result.ToJson().ToObject<List<Member_Account>>();
            }
            catch (Exception ex)
            {
                throw new Exception(ex.Message);
        ...
        public List<Member_Account> SearchAccountPro(int systemId, string companyId, string startTime, string endTime, string rankId, string delete, string keyword)
        {
            try
            {
                if (systemId == 0)
                ...
                int errCode = -1;
                string errMsg = "fail";
                var result = CTMSContext.SP_Search_Member_Account(systemId, companyId, startTime, endTime, rankId, delete, keyword, out errCode, out errMsg);
                if (errCode != 0)
                    throw new Exception(errMsg);
                if (result == null)
                    return null;
        ...
        public bool VerifyAccountLoginPro(int systemId, string companyId, string account, string password)
        {
            try
            {
                int errCode = -1;
                string errMsg = "fail";
                var result = CTMSContext.SP_Verify_Member_AccountLogin(systemId, companyId, account, password, out errCode, out errMsg);
                if (errCode != 0)
                    throw new Exception(errMsg);
                return errCode == 0 ? true : false;
            }
