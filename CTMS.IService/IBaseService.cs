...
namespace CTMS.IService
{
    ...
    public partial interface IBaseService<T> where T:class ,new()
    {
        ...
        IQueryable<T> FindList<type>(Expression<Func<T, bool>> whereLambda, Expression<Func<T, T>> scalarLambda, Expression<Func<T, type>> orderLambda, bool isAsc);
