...
namespace CTMS.IDAL
{
    ...
    public partial interface IBaseDAL 
    {
        ...
        long Count<T>(Expression<Func<T, bool>> whereLambda) where T : class;
        string ExecuteCommand(string cmdText);
        string ExecuteCommand(string cmdText, DbParameter[] sqlParameter);
